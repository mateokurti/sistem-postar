                ...
                <?php if (isset($_SESSION['flash']['success']) && $_SESSION['flash']['success']['form'] === '/auth/reset-password/confirm'): ?>
                    ...
                    <div class="mt-4">
                        <input value="<?php echo $_GET['email'] ?>"class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none hidden" type="email" name="email" placeholder=""> 
                    </div>
                    <div class="mt-4">
                        <input value="<?php echo $_GET['code'] ?>"class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none hidden" type="text" name="code" placeholder=""> 
                    </div>
                    <div class="mt-4">
