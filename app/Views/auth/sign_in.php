            ...
            <div class="w-full p-8 lg:w-1/2">
                ...
                <form id="sign-in-form" action="/sign-in" method="POST">
                    ...
                    <div class="mt-4">
                        ...
                        <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="email" name="email" placeholder="hello@fshn.edu.al">
                    </div>
                    <div class="mt-4">
                    ...
                    <div class="mt-4">
                        <div class="flex justify-between">
                            <div class="w-1/2 mr-1">
                                ...
                                <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="first_name" name="first_name" placeholder="Filan">
                            </div>
                            <div class="w-1/2 ml-1">
                                <label class="block text-gray-700 text-sm font-bold mb-2">Last Name</label>
                                <input class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="last_name" name="last_name" placeholder="Fisteku">
                            </div>
                        </div>
                    </div>
                    <div class="mt-4">
