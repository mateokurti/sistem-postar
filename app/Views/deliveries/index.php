        ...
        <tbody id="table-deliveries-body">
            ...
            ?>
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <div class="flex items-center">
                      <a data-modal-target="tracking-history-modal" data-modal-toggle="tracking-history-modal" id="open-tracking-modal" href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
